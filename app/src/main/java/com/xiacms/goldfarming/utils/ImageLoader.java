...
public class ImageLoader {
    ...
    public static void downloadImg(Context context, ImageView imageUrl, String thumb) {
        setImage(I.DOWNLOAD_IMG_URL + thumb, context, imageUrl, true);
    }

    public static void downloadImg(Context context, ImageView imageUrl, String thumb, boolean isDragging) {
        setImage(I.DOWNLOAD_IMG_URL + thumb, context, imageUrl, isDragging);
    }

    private static void setImage(String url, Context context, ImageView imageUrl, boolean isDragging) {
        ImageLoader.build(url)
                .defaultPicture(android.R.drawable.ic_search_category_default)
                .imageView(imageUrl)
