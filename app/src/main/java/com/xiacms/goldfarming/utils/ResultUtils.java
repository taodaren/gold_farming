...
import com.xiacms.goldfarming.mode_cart.bean.CartBean;
import com.xiacms.goldfarming.global.I;
import com.xiacms.goldfarming.mode_home.bean.ProductDetailsBean;
import com.xiacms.goldfarming.mode_home.bean.Result;
                        ...
                        try {
                            ...
                            if (jsonRetData != null) {
                                ...
                                try {
                                    date = URLDecoder.decode(jsonRetData.toString(), I.UTF_8);
                                    Log.e("Utils", "jsonRetData=" + date);
                                    ProductDetailsBean g = new Gson().fromJson(date, ProductDetailsBean.class);
                                    cart.setGoods(g);
